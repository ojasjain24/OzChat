...
public class profileActivity extends AppCompatActivity {
    ...
    private String statusS,countryS,professionS,genderS,languageS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        professionBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ShowDialog("Profession",professionS);
            }
        });
    ...
    public void ShowDialog(final String line, final String value){

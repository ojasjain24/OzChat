...
public class forwardMsgGroupAdapterGrp extends RecyclerView.Adapter<forwardMsgGroupAdapterGrp.Holder> {
    ...
    public forwardMsgGroupAdapterGrp() {
    }

    public forwardMsgGroupAdapterGrp(Context context, ArrayList<groupDataModel> data,ArrayList<groupChatModel> chatModel) {

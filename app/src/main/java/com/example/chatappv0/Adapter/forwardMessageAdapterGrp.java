...
public class forwardMessageAdapterGrp extends RecyclerView.Adapter<forwardMessageAdapterGrp.Holder> {
    ...
    public forwardMessageAdapterGrp() {
    }

    public forwardMessageAdapterGrp(Context context, ArrayList<friendsModel> data,ArrayList<groupChatModel> chatModel) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new forwardMessageAdapterGrp.Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.select_user_for_group,parent,false));
    }

...
import com.example.chatappv0.Adapter.forwardMsgAdapterG;

import com.example.chatappv0.Adapter.forwardMsgGroupAdapterG;
...
public class forwardMessageGroup extends AppCompatActivity {
    private com.example.chatappv0.Adapter.forwardMsgGroupAdapterG forwardMsgGroupAdapterG;
    private forwardMsgAdapterG forwardMsgAdapterG;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                forwardMsgAdapterG.uploadOnDataBase();
                forwardMsgGroupAdapterG.uploadOnDataBase();
                Intent i =new Intent(forwardMessageGroup.this,MainActivity.class);
                startActivity(i);
            }
        });
    }
    private void readusers() {
        ...
        final ArrayList<groupChatModel> list = (ArrayList<groupChatModel>) args.getSerializable("arrayList");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                forwardMsgAdapterG = new forwardMsgAdapterG(getApplicationContext(), userList,list);
                LinearLayoutManager manager=new LinearLayoutManager(forwardMessageGroup.this);
                manager.setReverseLayout(true);
                manager.setStackFromEnd(true);
                recyclerView.setLayoutManager(manager);
                recyclerView.setAdapter(forwardMsgAdapterG);
            }
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(forwardMessageGroup.this, "check your network connection", Toast.LENGTH_SHORT).show();
            }
        });
                    ...
                    if(user.getNodeid() != null){
                        ...
                        reference.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                forwardMsgGroupAdapterG = new forwardMsgGroupAdapterG(getApplicationContext(), userList,list);
                                LinearLayoutManager manager=new LinearLayoutManager(forwardMessageGroup.this);
                                manager.setStackFromEnd(true);
                                manager.setReverseLayout(true);
                                recyclerView2.setLayoutManager(manager);
                                recyclerView2.setAdapter(forwardMsgGroupAdapterG);
                            }
                            @Override
